section .data
	...
	msg2 : db 'enter the size of array 1 : '
	l2 : equ $-msg2

	msg3 : db 'enter the sorted array 1 : ',10
	l3 : equ $-msg3

	msg4 : db 'enter the size of array 2 : '
	l4: equ $-msg4

	msg5 : db 'enter the sorted array 2 : ',10
	l5: equ $-msg5

	msg6 : db 'the merged array is =>',10
	l6: equ $-msg6
